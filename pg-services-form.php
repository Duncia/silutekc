<?php 
/* Template Name: Services Form page */

/*
Services form page template
 */
?>
...
<section class="container">
    <div class="container__inner services-form d-grid-2 pb-lr">
        <div class="">
            <div class="contacts-title pb-md">
                <div class="contacts-title__line"></div>
                <h3 class="contacts-title__headline"><?php _e('Patalpų nuomos užklausa', 'siluteskc'); ?></h3>
            </div>
            <?php if (have_posts()) :
        ...
        <div class="">
            <div class="contacts-title pb-md">
                <div class="contacts-title__line"></div>
                <h3 class="contacts-title__headline"><?php _e('Kontaktai', 'siluteskc'); ?></h3>
            </div>
            <div class="services-departments">
                <div class="services-departments__address">
                    <div class="services-departments__address__item">
